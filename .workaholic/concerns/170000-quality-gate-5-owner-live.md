...
concern_id: 170000-quality-gate-5-owner-live
severity: low
status: active
resolved_by_pr: 
resolved_by_commit: 
...
The session-unlock's live confirmation on the real headless host cannot be run by an (`170000-quality-gate-5-owner-live.md`, origin `72c8950`)

## How to Fix

Owner runs the three-step live check post-merge.
