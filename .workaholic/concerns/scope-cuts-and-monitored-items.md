...
Deliberate switch/PDF/stripper scope cuts with no trigger condition recorded, and no prerequisite landed on this branch (see [f1a3d21](https://github.com/qmu/qfs/commit/f1a3d21)).

## How to Fix

Record an explicit trigger condition for each scope cut so a fresh session can detect when it is due.
