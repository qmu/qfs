---
type: Feedback
title: Passphrase prompt once-per-invocation limitation on headless hosts
kind: concern
source: development
...
supersedes:
severity: low
concern_id: passphrase-prompt-once-per-invocation-limitation
owner: 
mission: 
tickets: []
origin_pr: 13
