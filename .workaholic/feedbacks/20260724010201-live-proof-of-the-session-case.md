---
type: Feedback
title: Live proof of the session case deferred on host disk
kind: concern
source: development
...
Blocked on unreclaimed host disk, not code (see [9241270](https://github.com/qmu/qfs/commit/9241270)).
