...
- **When:** 2026-07-24T01:03:06+09:00
- **By:** a@qmu.jp
- **Target:** release-scan
- **Method:** override
- **Status:** bypassed
- **Observed:** size findings overridden by developer (batch approval for size-only findings): too-many-files 454 inflated by divergence (three-dot diff touches no qfs-viewer files) and two too-large commits 9ada311 1659, a73fa01 538 non-generated lines; no secret or leak findings

## Deployment Evidence

- **When:** 2026-07-24T01:08:29+09:00
- **By:** a@qmu.jp
- **Target:** github-release
- **Method:** other
- **Status:** pass
- **Observed:** pre-merge readiness proof green on merged branch: cargo test --workspace, clippy -D warnings, fmt --check, gen-docs --check, gen-skills --check all pass on clean tmpfs target; version 0.0.89 ahead of main 0.0.88; tag v0.0.89 free
