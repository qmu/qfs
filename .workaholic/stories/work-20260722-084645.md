...
- **When:** 2026-07-24T00:41:41+09:00
- **By:** a@qmu.jp
- **Target:** release-scan
- **Method:** override
- **Status:** bypassed
- **Observed:** size findings overridden by developer (batch approval for size-only findings): commits 0266e27 (3621), 7bac20f (2054), dcfd0b6 (698), 0b5ceba (690), 0a894ef (633) non-generated lines; driver-retirement plus codec-rehome plus mission housekeeping; no secret or leak findings

## Deployment Evidence

- **When:** 2026-07-24T00:48:00+09:00
- **By:** a@qmu.jp
- **Target:** github-release
- **Method:** other
- **Status:** pass
- **Observed:** pre-merge readiness proof green on merged branch: cargo test --workspace, clippy -D warnings, fmt --check, gen-docs --check, gen-skills --check all pass on clean tmpfs target; version 0.0.87 ahead of main 0.0.85; tag v0.0.87 free; plugin 0.15.0 minor bump verified across all four fields
