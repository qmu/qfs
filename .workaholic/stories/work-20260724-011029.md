...
- **When:** 2026-07-28T12:50:37+09:00
- **By:** a@qmu.jp
- **Target:** release-scan
- **Method:** override
- **Status:** bypassed
- **Observed:** size override accepted: commits ac7a4c7 1003, 96a4912 787, 215d15c 594 non-generated lines against the 500 threshold; zero secret and zero leak findings
...
- **Status:** pass
- **Observed:** all six gate commands exited 0 after catching up with main and re-bumping past the version collision: build, test --workspace with 151 suites ok and zero failures, clippy -D warnings, fmt --check, gen-docs --check, gen-skills --check; Cargo.toml version 0.0.91 is ahead of main 0.0.90 and tag v0.0.91 is unused
