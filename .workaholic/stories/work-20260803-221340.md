...
- **When:** 2026-08-04T20:58:32+09:00
- **By:** a@qmu.jp
- **Target:** qfs GitHub Release (release-on-tag)
- **Method:** other (post-merge promotion check)
- **Status:** pass
- **Observed:** gh release view v0.0.94 reports isDraft false with 8 assets: the four native tarballs (aarch64/x86_64 apple-darwin and unknown-linux-musl) plus their sha256 files; release.yml run 30906463742 completed success; tag v0.0.94 points at merge commit e81e5d6
