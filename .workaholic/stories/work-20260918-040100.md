...
- **Before release:** ~~Acknowledge that size override consciously at `/ship`.~~ **Overridden
  2026-09-18 on the developer's instruction to ship.** The finding is one commit's implementation
  size, not a secret or a leak; the branch's gates are green and the upload was proved live.
