...
//! `cfs` library facet — the composition-root code shared by the `cfs` binary (`main.rs`)
//! and the `xtask` build tooling.
//!
//! The `cfs` crate is primarily the **single binary** (RFD-0001 §9). It also exposes this
