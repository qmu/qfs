//! Owned DTOs for object/list/version metadata (RFD-0001 §9 owned-DTO discipline): the
...
pub struct ObjectMeta {
    ...
    /// The object version id on a versioned bucket (RFD §4 temporal coordinate); `None` otherwise.
