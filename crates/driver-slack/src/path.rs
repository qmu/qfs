//! [`SlackPath`] — the parse of a cfs [`Path`](cfs_driver::Path) into the concrete Slack node it
...
/// archetype (the multi-archetype property) and a typed [`Schema`](cfs_types::Schema). Declaration
