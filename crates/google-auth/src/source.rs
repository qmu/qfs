...
//! `access_token` is **synchronous**, matching the t18 [`cfs_driver_http::HttpClient`] seam and
//! the synchronous-applier discipline of every cfs driver (the runtime bridge offloads the
