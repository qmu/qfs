...
//! Both the access-token value and the refresh-token value are [`cfs_secrets::Secret`]: they
...
pub struct GoogleAccount {
    ...
    pub email: String,
    /// The long-lived refresh token. A [`Secret`]; persisted via [`cfs_secrets::Secrets`].
