//! The DAG **frontier scheduler** (RFD-0001 §6): yields successive ready-sets of effect
...
//! `cfs_plan::topo_order`, but *incremental* — it exposes one layer at a time and lets the
...
/// order for determinism (matching `cfs_plan::topo_order`).
#[derive(Debug)]
pub struct Frontier {
...
impl Frontier {
    ...
    /// shallow DAGs cfs plans produce.
