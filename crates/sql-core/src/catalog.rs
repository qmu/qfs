//! `catalog` — owned, vendor-free catalog DTOs and the SQL→cfs schema reconciliation (RFD-0001
...
use cfs_types::{Column, ColumnType, DriverId, Provenance, Schema};
...
pub struct ColumnDef {
    /// The column name.
    pub name: String,
    /// The canonical cfs column type (already mapped from the backend SQL type).
    pub ty: ColumnType,
