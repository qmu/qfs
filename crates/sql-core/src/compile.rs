//! `compile` — the pure **cfs query → parameterized SQL plan** compiler (RFD-0001 §5/§6, ticket
...
//! - `LIKE` (cfs glob vs SQL `LIKE` differ), `~` (regex not portable across pg/mysql/sqlite),
