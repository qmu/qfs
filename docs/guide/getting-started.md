...
cat credentials.json | qfs app add google qmu # your Google OAuth app's client credentials
qfs account add google --app qmu             # paste-back browser consent; the token is sealed,
