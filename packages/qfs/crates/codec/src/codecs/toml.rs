//! `TomlCodec` — a TOML document ↔ rows (blueprint §4). A TOML document is a single top-level
...
//!
//! Documented non-preservation (blueprint §4): TOML comments and key ordering/section layout
