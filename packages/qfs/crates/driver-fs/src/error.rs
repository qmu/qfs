//! The structured `fs` driver error (blueprint §6: errors must be machine-readable for an AI,
...
impl From<FsError> for EffectError {
    ...
    /// retry/ledger logic — and the audit ledger — can branch on its class (blueprint §6/§7). The
