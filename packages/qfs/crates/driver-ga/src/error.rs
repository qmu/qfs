//! The structured Google Analytics driver error (blueprint §6: machine-readable for an AI, never
...
impl From<GaError> for EffectError {
    ...
    /// retry/ledger logic can branch on its class (blueprint §6/§7). A read-only denial maps to
