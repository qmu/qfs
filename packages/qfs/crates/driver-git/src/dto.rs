...
//! relational/log nodes + the typed [`Schema`] each declares for `DESCRIBE` (blueprint §6/§11). No
...
/// The `/git/<repo>/commits` row (blueprint §6): `sha, tree, parents, author, committer, time,
