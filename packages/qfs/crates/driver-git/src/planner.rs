//! Pure write-plan builders (blueprint §3 purity invariant: every write builds a [`Plan`] and applies
...
/// keyword — blueprint §3 keyword-clash resolution). Builds the staged blobs → a tree → the commit
