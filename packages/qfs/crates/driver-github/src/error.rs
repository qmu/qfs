//! [`GitHubError`] — the driver's structured, **secret-free** error taxonomy (blueprint §6/§7).
//!
...
impl GitHubError {
    ...
    /// terminal so the interpreter never re-sends it (blueprint §7 — at-least-once, no silent retry of
