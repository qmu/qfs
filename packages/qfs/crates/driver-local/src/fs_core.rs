...
//! **internal** to this module (blueprint §11) — only [`LocalRow`], owned paths, byte counts, and
//! [`LocalError`] cross the boundary.
//!
//! ## Sandbox (blueprint §8 least privilege)
...
/// hash match the source (the copy→verify shape, blueprint §7). Size-only verification cannot catch
