...
//! sync→async bridge (blueprint §3/§7). Proves a real driver runs the full effect-plan path:
...
use qfs_driver_local::{blob_write_args, copy_move_args, local_apply_driver, LocalFsDriver};
