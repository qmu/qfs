//! The SQL driver's error surface (blueprint §6). The structured, secret-free [`SqlError`] enum
...
/// retry/ledger logic can branch on its class (blueprint §6/§7). A view-write denial maps to
