//! [`OAuthClient`] — the thin Google OAuth2 endpoints client (blueprint §6/§171): builds the
...
//! adapter).
//!
//! ## The load-bearing redirect detail (blueprint §8, the hard part)
...
impl OAuthClient {
    ...
    /// minimum scope set (least privilege, blueprint §8). Network rides `http`.
    #[must_use]
    pub fn new(
