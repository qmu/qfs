//! **Planner E2E / external-interface validation** for t36 deployment targets (blueprint §10/§11).
//!
...
fn scenario6_secret_values_cannot_flow_into_the_wrangler_or_a_ledger_line() {
    // The hygiene invariant (blueprint §8): the seam carries credentials by HANDLE / NAME only — there
