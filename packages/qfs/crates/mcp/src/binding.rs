...
/// The maximum MCP request body the binding accepts (a bounded buffer — blueprint §7 resource
...
pub enum AuthDecision {
    ...
    /// The reason NEVER carries the token / a claim value (blueprint §8).
    Deny {
...
impl McpBinding {
    ...
    pub fn handle(&self, req: &HttpRequest) -> HttpResponse {
        ...
        // 4. Bounded body (blueprint §7). An over-large payload is refused before parse.
