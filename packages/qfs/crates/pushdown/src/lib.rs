//! `qfs-pushdown` — the **pushdown planner** (blueprint §7 pushdown federation, the
...
//!
//! ## Purity & determinism (blueprint §3)
...
pub use lower::{lower_predicate, lower_query, lower_scalar, LowerError};
