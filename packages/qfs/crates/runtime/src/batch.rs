//! Frontier **coalescing** (blueprint §7 auto-batching): group a ready-set of effect nodes
...
//! [`EffectKind`] label — never a vendor SDK type (blueprint §11). Grouping happens across the
