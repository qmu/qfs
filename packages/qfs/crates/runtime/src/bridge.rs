...
//! and `qfs-driver` stay off `tokio` (the purity invariant, RFD §3). The lone impure seam
...
/// dispatches through (RFD §5/§9). The interpreter resolves a [`qfs_types::DriverId`] to
