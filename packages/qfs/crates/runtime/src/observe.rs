//! Observability surface for the transactional commit (blueprint §7 observability, §8 audit).
//!
...
//!
//! Secret-free invariant (blueprint §8): spans/events carry **identity and shape only** — the
...
/// A per-execution trace id (blueprint §7) threaded through the plan → effect → external-call span
