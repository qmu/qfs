//! The applied-effect **ledger** (blueprint §7 recovery substrate, §8 audit). Every leg is
...
//! effect **metadata only**, never payloads, credentials, or tokens (blueprint §8).
...
/// One ledger entry: the full record of an effect's disposition (blueprint §7/§8). Serializable
...
/// ledger plus roll-up accounting (blueprint §7). The ledger is the recovery substrate — a
