//! The fire-path enforcement helper (blueprint §10/§8): the single reusable seam every E7 committer
...
///   never accidentally allow — blueprint §8).
...
/// only — NEVER a row payload or credential (blueprint §8). Read dependencies are included with
