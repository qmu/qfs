//! `emit` — the per-dialect **native-SQL emitter** (blueprint §6/§7, ticket steps 6/10). It
...
use qfs_types::{CmpOp, Literal, Value};

use crate::dialect::Dialect;

/// A bound parameter value — an owned scalar mirroring the qfs scalar [`Value`]s the backend
