//! Codec round-trip checks (t38, blueprint §4/§11): `roundtrip_codec(fmt, bytes) -> RoundTrip`
...
//! for several codecs (blueprint §4 markdown note). The load-bearing invariant is **row stability
