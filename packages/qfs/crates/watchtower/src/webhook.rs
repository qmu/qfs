//! **Inbound webhook ingestion** (t34, blueprint §10/§8): [`WebhookBinding`] implements
...
/// The `qfs-secrets` driver namespace webhook signing secrets live under (blueprint §8 — resolved by
...
impl WebhookIngest {
    ...
    pub fn ingest(
        ...
        // Signature verification (blueprint §8 replay defense). An empty handle = unsigned (accepted
    ...
    fn verify_signature(
        ...
        // Compute the expected tag over the body; compare CONSTANT-TIME (blueprint §8).
