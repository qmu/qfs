---
name: qfs-slack
description: Use for Slack through QFS — discover connected accounts and public/private channels from live describe output, read messages and threads, and post to the requested channel or thread. Check installed views and write maps before concluding a channel or capability is unavailable.
---
